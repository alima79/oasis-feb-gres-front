...
export class ListarComponent implements OnInit {
  ...
  openDialog(acaoRS: string, dados: IRestauranteSeating): void{
    console.log("DADOS ENVIADOS NO LISTAR:  " +dados);
    console.log("DADOS.RESTAURANTE ENVIADOS NO LISTAR:  " +dados.restaurante);
    console.log("DADOS.SEATING ENVIADOS NO LISTAR:  " +dados.seating);
    console.log("DADOS.MENU ENVIADOS NO LISTAR:  " +dados.menu);

    console.log('EIIII estou aqui..... ' + JSON.stringify(dados));
  ...
  apagarRestauranteSeating(idRS: number): void{
